...
//   ../costplus_suite/output/trumprx_comparison.csv   (costplus_suite/output/trumprx_comparison.csv)
// Adjust the three paths below if this file is relocated. All three are
// costplus_suite/output/*.csv -- gitignored, generated by running
// `python run.py` from the repo root first. Panel 4 renders its "missing"
// state until that CSV exists.
//
...
function TrumpRxPanel({ rows, status }) {
  ...
  return (
    <section className="border border-[#1b2436] bg-[#0d1424] p-4">
      ...
      {status !== "ready" ? (
        <div className="text-sm text-[#5f6b85]">output/trumprx_comparison.csv not available yet &mdash; run `python run.py` from the repo root first.</div>
      ) : (
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-collapse font-mono tabular-nums">
            <thead>
